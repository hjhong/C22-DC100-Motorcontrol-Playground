...
{
	xscope_register(4,
	        XSCOPE_CONTINUOUS, "current phaseB", XSCOPE_INT, "n",
			XSCOPE_CONTINUOUS, "current phaseC", XSCOPE_INT, "n",
			XSCOPE_CONTINUOUS, "target_torque", XSCOPE_INT, "n",
			XSCOPE_CONTINUOUS, "actual_torque", XSCOPE_INT, "n");
}
